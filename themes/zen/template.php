...
function zen_menu_link(array $variables) {
  ...
  if ($element['#original_link']['menu_name']=="menu-enlaces") {
    return '<li' . drupal_attributes($element['#attributes']) .'><a href=' .  $element['#href'] .'><img src='. file_create_url(file_load($element['#localized_options']['content']['image'])->uri) . '></a></li>';
  }
  else {
